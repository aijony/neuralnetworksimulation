package tut.src.com.shc.tutorials.lwjgl.tutorial1;

import tut.src.com.shc.tutorials.lwjgl.Game;
import tut.src.com.shc.tutorials.lwjgl.util.ShaderProgram;
...
public class Tutorial1 extends Game
{
    ...
    public void init()
    {
        ...
        shaderProgram.attachVertexShader("tut/src/com/shc/tutorials/lwjgl/tutorial1/Tutorial1.vs");
        shaderProgram.attachFragmentShader("tut/src/com/shc/tutorials/lwjgl/tutorial1/Tutorial1.fs");
        shaderProgram.link();
